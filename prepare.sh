...
# k-means clustering
python hubert/simple_kmeans/learn_kmeans.py ${feat_dir} genshin_train ${nshard} km_train.joblib.pkl ${n_cluster} --percent 0.1
python hubert/simple_kmeans/learn_kmeans.py ${feat_dir} genshin_valid ${nshard} km_valid.joblib.pkl ${n_cluster} --percent 0.1
python hubert/simple_kmeans/learn_kmeans.py ${feat_dir} genshin_test ${nshard} km_test.joblib.pkl ${n_cluster} --percent 0.1
# k-means application
python hubert/simple_kmeans/dump_km_label.py ${feat_dir} genshin_train km_train.joblib.pkl ${nshard} ${rank} ${lab_dir}
python hubert/simple_kmeans/dump_km_label.py ${feat_dir} genshin_valid km_valid.joblib.pkl ${nshard} ${rank} ${lab_dir}
python hubert/simple_kmeans/dump_km_label.py ${feat_dir} genshin_test km_test.joblib.pkl ${nshard} ${rank} ${lab_dir}
